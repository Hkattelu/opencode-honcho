...
- Terminal/TUI surfaces clarify status vs settings, make `/honcho:setup` the primary setup path, remove obsolete write-frequency controls, and distinguish session-message search from durable conclusion capture.
